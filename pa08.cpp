...
int main()
{
    ...
    for (int i = 0; i < 1000; i++)
      unordered_map_obj.insert(MyPair<std::string, int>(std::to_string(i),i));

    unordered_map_obj.print();

    for (int i = 0; i < 1000; i++)
      unordered_map_obj.erase(std::to_string(i));
cout << endl;
    unordered_map_obj.print();
